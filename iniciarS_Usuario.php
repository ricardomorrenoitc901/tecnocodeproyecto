        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page"><a href="iniciarS_Usuario.php">Usuario</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="iniciarS_Admin.php">Administrador</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-secondary p-5">
                        ...
                        <p class="mb-4">Para registrar empresas o ofertas, debes iniciar sesión. Si no tienes cuenta, <a href="formUsuarios.html">Regístrate aquí</a>.</p>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100">
                        <img class="img-fluid h-100" src="img/empresas2.webp" alt="">
                    </div>
                </div>
            </div>
        </div>
