...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Perfil del Usuario</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="indexUsuario.php">Inicio</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Perfil</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100">
                        <img class="img-fluid h-100" src="img/perfil.png" id="perfil" width="300px" height="300px">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
                        <h1 class="text-uppercase mb-4">Perfil del Usuario</h1>
                        <div>
                            <div class="d-flex justify-content-between border-bottom py-2">
                                <h6 class="text-uppercase mb-0">Nombre</h6>
                                <span class="text-uppercase text-primary"><?php echo $_SESSION['nombre']; ?></span>
                            </div>
                            <div class="d-flex justify-content-between border-bottom py-2">
                                <h6 class="text-uppercase mb-0">Apellido Parterno</h6>
                                <span class="text-uppercase text-primary"><?php echo $_SESSION['aPaterno']; ?></span>
                            </div>
                            <div class="d-flex justify-content-between border-bottom py-2">
                                <h6 class="text-uppercase mb-0">Apellido Materno</h6>
                                <span class="text-uppercase text-primary"><?php echo $_SESSION['aMaterno']; ?></span>
                            </div>
                            <div class="d-flex justify-content-between border-bottom py-2">
                                <h6 class="text-uppercase mb-0">Correo</h6>
                                <span class="text-uppercase text-primary"><?php echo $_SESSION['correo']; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
