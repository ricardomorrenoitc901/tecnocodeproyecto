...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Empresa Registrada</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="indexUsuario.php">Inicio</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Empresa Registrada</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="mb-4 wow fadeIn" data-wow-delay="0.5s">
                        <img class="img-fluid h-100" src="img/welcome.png" width="200px">
                    </div>
                    <h1 class="mb-4">La empresa ha sido registrada.</h1>
                    <h5 class="mb-4" style="color: red;">¿Deseas llenar el Talento Humano?</h5>
                    <a class="btn btn-primary py-3 px-5" href="formOfertas.php">Ir</a>&nbsp;&nbsp;
                    <a class="btn btn-primary py-3 px-5" href="indexUsuario.php">Volver</a>
                </div>
            </div>
        </div>
    </div>
