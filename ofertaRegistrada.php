...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Oferta Registrada</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="indexUsuario.php">Inicio</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Oferta Registrada</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">La oferta ha sido registrada.</h1>
                    <div class="mb-4 wow fadeIn" data-wow-delay="0.5s">
                        <img class="img-fluid h-100" src="img/exito.webp" width="400px">
                    </div>
